...
#
# Options are categorized into the follow 3 sections:
#   Part 1: db_bench options;
#   Part 2: options that changed by db_bench are reverted to the RocksDB default;
#   Part 3: options for optimizing level style compaction to make it compatible
